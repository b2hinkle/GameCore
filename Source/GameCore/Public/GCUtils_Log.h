 ...
 */
#define GC_CONTEXT_OBJECT_FORMAT_ARGS(contextObject, contextObjectArgCString) contextObjectArgCString, *GCUtils::GetUObjectNameSafe(contextObject), GCUtils::GetWorldNetModeCString(contextObject), GCUtils::GetObjectLocalRoleCString(contextObject), *GCUtils::GetUObjectNameSafe(GCUtils::GetController(contextObject)), GCUtils::Log::GetIsControllerLocalCString(contextObject)
